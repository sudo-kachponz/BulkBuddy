...
def get_llms(model_name: str="anthropic/claude-3.5-sonnet", temperature=0):
    """
    ...
    Args:
        model_name: The name of the model to use
                   - "anthropic/claude-3.5-sonnet" (default) for robust tool calling
    ...
    if model_name == "custom-vlm":
        model_name = "anthropic/claude-3.5-sonnet" # fallback to openrouter default
